...
public class Botao7 : MonoBehaviour
{
    ...
    public static string resposta7 = "Não Respondeu";
    int sair = 0;
    ...
    public void botaoR1()
    {
        resposta7 = input.GetComponent<InputField>().text;
        Debug.Log("Resposta 7: " + resposta7);
        sair = 1;
    }
}
