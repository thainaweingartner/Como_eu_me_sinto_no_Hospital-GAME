...
public class Botao9 : MonoBehaviour
{
    public GameObject player;
    public GameObject posicao;
    public GameObject input;
    public GameObject carta;
    public static string resposta9 = "Não Respondeu";
    int sair = 0;
    ...
    public void botaoR1()
    {
        resposta9 = input.GetComponent<InputField>().text;
        Debug.Log("Resposta 9: " + resposta9);
        sair = 1;
    }
}
