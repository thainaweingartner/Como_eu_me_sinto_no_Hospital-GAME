...
public class Botao5 : MonoBehaviour
{
    ...
    public static string resposta5 = "Não Respondeu";
    int sair = 0;
    ...
    public void botaoR1()
    {
        resposta5 = input.GetComponent<InputField>().text;
        Debug.Log("Resposta 5: " + resposta5);
        sair = 1;
    }
}
