...
public class Botao8 : MonoBehaviour
{
    public GameObject player;
    public GameObject posicao;
    public GameObject input;
    public GameObject carta;
    public static string resposta8 = "Não Respondeu";
    int sair = 0;
    ...
    public void botaoR1()
    {
        resposta8 = input.GetComponent<InputField>().text;
        Debug.Log("Resposta 8: " + resposta8);
        sair = 1;
    }
}
