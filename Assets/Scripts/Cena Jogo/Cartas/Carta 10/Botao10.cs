...
public class Botao10 : MonoBehaviour
{
    public GameObject player;
    public GameObject posicao;
    public GameObject input;
    public GameObject carta;
    public static string resposta10 = "Não Respondeu";
    int sair = 0;
    ...
    public void botaoR1()
    {
        resposta10 = input.GetComponent<InputField>().text;
        Debug.Log("Resposta 10: " + resposta10);
        sair = 1;
    }
}
